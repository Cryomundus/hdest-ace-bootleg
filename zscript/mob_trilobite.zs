...
class Trilobite:HDMobBase replaces Cacodemon{
	...
	default{
		...
		obituary "%o was inverted by a $TAG.";
		speed 4;
		maxtargetrange 8192;
	}
	override void beginplay(){
	...
	void A_CacoMeleeZap(){
		...
		ZapArc(tracer,tgt,ARC2_RANDOMDEST,radius:64,height:64);
	}
	...
	deadzapping:
		...
		HEAD L 1{
			if(!random(0,3))ArcZap(self,radius*1.6,8,true);else ZapArc(self);
