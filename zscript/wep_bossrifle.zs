...
class BossRifle:HDWeapon{
	...
	override void DetachFromOwner(){
		if(handrounds>0){
			if(owner)owner.A_DropItem("SevenMilAmmo",handrounds);
			else A_DropItem("SevenMilAmmo",handrounds);
		}
	...
	altfire:
		...
		BARG B 1 offset(4,38) A_JumpIf(invoker.weaponstatus[BOSSS_CHAMBER]>2,"jamderp");
