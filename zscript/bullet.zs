...
class HDB_50:HDBulletActor{
	default{
		pushfactor 0.4;
		mass 420;
		speed HDCONST_MPSTODUPT * 920;//1100;
		accuracy 666;
		stamina 1270;
		woundhealth 10;
...
class HDB_wad:HDBulletActor{
	default{
		pushfactor 10.;
		mass 12;
		speed HDCONST_MPSTODUPT * 200;//300; //presumably most energy is transferred to the shot
		accuracy 0;
		stamina 1900;
		woundhealth 5;
...
class HDB_frag:HDBulletActor{
	default{
		pushfactor 0.7;
		mass 1;
		speed HDCONST_MPSTODUPT * 900;//600;
		accuracy 400;
		stamina 300;
		woundhealth 6;
...
class HDB_scrap:HDB_frag{
	default{
		pushfactor 5.;
		mass 30;
		speed HDCONST_MPSTODUPT * 140;//200;
		accuracy 100;
		stamina 800;
		woundhealth 20;
		deathheight 0.05;
