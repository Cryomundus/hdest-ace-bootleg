...
class HDBlurSphere:HDDamageHandler{
	...
	override int,name,int,int,int,int,int,int HandleDamagePost(
		...
		if(
			...
			string msg="";
			switch(random(0,10)){
				case 0:msg="you die";break;
				case 1:msg="blood";break;
				case 2:msg="i hate you";break;
				case 3:msg="it hurts";break;
				case 4:msg="worthless";break;
				case 5:msg="error";break;
				case 6:msg="hello";break;
			}
	...
	override void tick(){
		...
		if(
			...
			string msg="it hurts";
			switch(random(0,10)){
				case 0:msg="i hate you";break;
				case 1:msg="error";break;
				case 2:msg="noise";break;
				case 3:msg="your eyes";break;
				case 4:msg="nothing";break;
			}
