...
extend class HDFist{
	action void A_ChunkFlick(){
		if (!CountInv("WallChunkAmmo")){
			...
			if (blockinv){
				if (HDPlayerPawn(self)&&HDPlayerPawn(self).hd_helptext)A_Log("...or you would, except your "..blockinv.gettag().." covers your face. Take it off before you do this.", true);
				return;
			}
		}
