...
* `hd_maxstrength` (11): Maximum allowed value for `hd_strength`.
...
* **Potion of Goodness**
  ...
  Heals you over time. In fact, it can "over-heal" you so that if you're hurt later, you can recover faster because of your prior drinking! (Please do not apply this logic to other bottled materials that some people use in lieu of actual spiritual healing.)

* **Shield Core**

  GZDoom actor name: `ShieldCore`

  Another alien artifact of even more questionably monstrous nature. Gives you a non-regenerating shield similar to that found on some monsters.
...
* fireswitch - 0-4, default/semi only/semi-burst/semi-full/semi-burst-full
...
* lefty - 0/1, whether the brass comes out on right (id default true)
